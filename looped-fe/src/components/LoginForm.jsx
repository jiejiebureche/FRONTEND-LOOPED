      ...
      <div className="flex h-screen w-screen bg-[url(./assets/looped-bg.png)] bg-cover bg-center bg-no-repeat items-center justify-center">
        <form className="login-form flex flex-col bg-white w-1/2 h-3/5 rounded-[10px] items-center justify-center-safe">
          ...
          <div className="flex flex-row">
            ...
            <Link to="/signup" className="form-text">Sign up</Link>
          </div>
          ...
          <div className="flex flex-col w-2/3">
            ...
            <input placeholder="Email" className="mt-1 p-2 border-1 border-solid border-gray-300 rounded-[7px]" type="email"/>
            <label className="field-label text-left mt-5 mb-1">Password</label>
            <input placeholder="Password" className="mt-1 p-2 border-1 border-solid border-gray-300 rounded-[7px]" type="password"/>
            <div className="flex justify-end mt-4">
              <Link to="/forgetpass" className="form-text">Forget Password?</Link>
            </div>
          </div>
